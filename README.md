...
把照片的精神用中国瓷器碎片重新拼合：破碎、缺失、釉色与大面积留白。
...
<table>
  <tr>
    <td width="50%"><img src="./assets/examples/sample-05.png" alt="XXD Panel 224 样张 5"></td>
    <td width="50%"><img src="./assets/examples/sample-06.png" alt="XXD Panel 224 样张 6"></td>
  </tr>
  <tr>
    <td width="50%"><img src="./assets/examples/sample-07.png" alt="XXD Panel 224 样张 7"></td>
    <td width="50%"><img src="./assets/examples/sample-08.png" alt="XXD Panel 224 样张 8"></td>
  </tr>
</table>
...
<table>
  <tr>
    <td width="50%"><img src="./assets/examples/sample-09.png" alt="XXD Panel 224 新增上下样张 1"></td>
    <td width="50%"><img src="./assets/examples/sample-10.png" alt="XXD Panel 224 新增上下样张 2"></td>
  </tr>
  <tr>
    <td width="50%"><img src="./assets/examples/sample-11.png" alt="XXD Panel 224 新增上下样张 3"></td>
    <td width="50%"><img src="./assets/examples/sample-12.png" alt="XXD Panel 224 新增上下样张 4"></td>
  </tr>
</table>

## 适用场景与解决的问题

适合需要把一张普通照片做成收藏级东方海报的场合：个人摄影整理、独立出版、展览练习、文化品牌视觉。上半保留可辨认的原照；下半不是瓷片滤镜，而是先读懂含义、情绪与隐喻，再用釉面、胎土断口、裂纹和间隙把主体重新拼合。

整体呈现诗意、克制、当代、东方、具有心理张力和收藏感的视觉气质：小尺度章印、大面积瓷白留白、破碎与重新聚合，避免逐物复刻、画面填满、传统纹样堆砌、古董展示感、廉价国潮感和 3D 塑料感。
...
安装后重新启动 Agent 会话，然后调用 `$xxd-panel-224`。也可以按需追加 `--global --agent codex --yes` 做用户级安装。

常用调用示例：

```text
/xxd-panel-224 photo.jpg --mode top-bottom --size 3:4 --text prompt --locale zh-CN
...
完整运行契约见 [SKILL.md](SKILL.md)；运行适配器见 [英文](references/xxd-panel-224-prompt.en.md) 与 [中文](references/xxd-panel-224-prompt.zh-CN.md)。
...
- `design-only`：整张画布只呈现 Panel 224 的设计转译，照片只作为不可见参考。
