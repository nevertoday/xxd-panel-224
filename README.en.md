...
# XXD Panel 224｜瓷器碎片拼合重构

Rebuild the photograph's spirit from Chinese porcelain shards: breakage, gaps, glaze colour and generous white space.
...
<table>
  <tr>
    <td width="50%"><img src="./assets/examples/sample-05.png" alt="XXD Panel 224 Sample 5"></td>
    <td width="50%"><img src="./assets/examples/sample-06.png" alt="XXD Panel 224 Sample 6"></td>
  </tr>
  <tr>
    <td width="50%"><img src="./assets/examples/sample-07.png" alt="XXD Panel 224 Sample 7"></td>
    <td width="50%"><img src="./assets/examples/sample-08.png" alt="XXD Panel 224 Sample 8"></td>
  </tr>
</table>
...
<table>
  <tr>
    <td width="50%"><img src="./assets/examples/sample-09.png" alt="XXD Panel 224 additional top-bottom sample 1"></td>
    <td width="50%"><img src="./assets/examples/sample-10.png" alt="XXD Panel 224 additional top-bottom sample 2"></td>
  </tr>
  <tr>
    <td width="50%"><img src="./assets/examples/sample-11.png" alt="XXD Panel 224 additional top-bottom sample 3"></td>
    <td width="50%"><img src="./assets/examples/sample-12.png" alt="XXD Panel 224 additional top-bottom sample 4"></td>
  </tr>
</table>

## Best-fit situations and problems solved

For a collectible Eastern poster from an ordinary photograph: personal archives, independent publishing, exhibition studies and cultural-brand work. The upper half keeps a recognisable source photograph; the lower half is not a porcelain filter. It first reads meaning, mood and metaphor, then rebuilds the subject from glaze, biscuit breaks, cracks and gaps.

The result should feel poetic, restrained, contemporary and Eastern, with psychological tension and a collector's quiet: a small stamp-like form in abundant porcelain-white space. Avoid literal copies, filled frames, stacked traditional patterns, antique-display styling, cheap national-tide graphics and 3D plastic.
...
```bash
npx skills add https://github.com/nevertoday/xxd-panel-224 --skill xxd-panel-224
```

Restart the agent session after installation, then invoke `$xxd-panel-224`. Add `--global --agent codex --yes` when a user-level Codex installation is wanted.

Common examples:

```text
/xxd-panel-224 photo.jpg --mode top-bottom --size 3:4 --text prompt --locale en-US
/xxd-panel-224 photo.jpg --mode left-right --size 16:9 --text prompt --locale en-US
/xxd-panel-224 photo.jpg --mode design-only --size 9:16 --text none --prefs off
/xxd-panel-224 ./photos --mode design-only --size auto,3:4 --text prompt --locale ja-JP
```

See [SKILL.md](SKILL.md) for the full runtime contract and the [English](references/xxd-panel-224-prompt.en.md) or [Chinese](references/xxd-panel-224-prompt.zh-CN.md) runtime adapter.
...
- `design-only`: the full canvas contains only Panel 224's designed translation; the photograph remains a non-visible reference.
