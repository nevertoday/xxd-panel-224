...
أعد بناء روح الصورة من شظايا الخزف الصيني: الكسر، الفراغ، لون التزجيج والمساحة البيضاء الواسعة.
...
مناسب للأرشيف الشخصي والنشر المستقل ودراسات المعارض والهوية الثقافية. النصف العلوي يحتفظ بالصورة الأصلية القابلة للتعرف؛ والنصف السفلي ليس مرشح خزف. يقرأ المعنى والمزاج والاستعارة ثم يعيد بناء الموضوع من التزجيج وكسور البدن والشقوق والفراغات.

النتيجة شعرية ومقيدة ومعاصرة وشرقية، بتوتر نفسي وإحساس مقتنيات: شكل صغير كختم في بياض خزفي واسع. تجنّب النسخ الحرفي، وملء الإطار، وتكديس الزخارف التقليدية، وعرض التحف، والرسوم الوطنية الرخيصة، والبلاستيك ثلاثي الأبعاد.
...
بعد التثبيت أعد تشغيل جلسة Agent ثم استدعِ `$xxd-panel-224`. ويمكن إضافة `--global --agent codex --yes` للتثبيت على مستوى المستخدم.

```text
/xxd-panel-224 photo.jpg --mode top-bottom --size 3:4 --text prompt --locale ar-SA
...
راجع [SKILL.md](SKILL.md) لعقد التشغيل الكامل، ومهايئ التشغيل [بالإنجليزية](references/xxd-panel-224-prompt.en.md) أو [بالصينية](references/xxd-panel-224-prompt.zh-CN.md).
...
- `design-only`: تعرض اللوحة الكاملة ترجمة Panel 224 التصميمية فقط، وتبقى الصورة مرجعاً غير ظاهر.
